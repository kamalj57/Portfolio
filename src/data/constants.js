...
export const education = [
  {
    ...
    grade: "8.55 CGPA",
    desc: "I am currently pursuing a Bachelor's degree in Computer Science and Engineering at Kongu Engineering College, Erode. I have completed 5 semesters and have a CGPA of 8.55. Additionally, I am studying for an Honours degree with specialization in Data Science",
  ...
  },
  {
    ...
    date: "May 2021",
    grade: "93.06%",
    desc: "I completed my class 12 high school education at Venganar Vajram Matric Hr Sec School.",
...
export const projects = [
  ...
  },
  {
    ...
    description: "Developed a full-stack web application that allows users to manage their income and expenses.",
    image: expensetracker,
    tags: ["MERN", "React-Chartjs"],
    category: "web app",
  ...
  },
  {
    ...
    description: "Developed a full-stack web application that provides prior notifications of bus services using the MERN stack and Twilio for sending notifications. Node Cron is used for scheduling in the event of E-Horyzon'24 @ KEC.",
    image: kecvms,
    tags: ["MERN", "Twilio"],
    category: "web app",
